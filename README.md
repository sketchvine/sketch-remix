...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create sketch-remix-e674
  fly apps create sketch-remix-e674-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app sketch-remix-e674
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app sketch-remix-e674-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'sketch-remix-e674-staging' does not match app name in config file 'sketch-remix-e674'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name sketch-remix-e674-db
  fly postgres attach --app sketch-remix-e674 sketch-remix-e674-db

  fly postgres create --name sketch-remix-e674-staging-db
  fly postgres attach --app sketch-remix-e674-staging sketch-remix-e674-staging-db
  ```
